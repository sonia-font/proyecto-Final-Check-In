        ...
        {reservation &&
          <table style={{
            ...
            <tr>
              ...
              {(reservation.estado === "iniciado" || reservation.estado === "completo") && <td className="table-subtitle">Habitacion</td>}
            </tr>
            <tr>
              ...
              <td>{(reservation.estado === "iniciado" || reservation.estado === "completo") && reservation.habitacion === null && <input style={{
                width: "50px",
                height: "25px"
              }}
